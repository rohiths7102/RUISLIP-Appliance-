...
async function rows() {
  ...
  return c.brands.map((b) => ({ id: b.id, name: b.name, slug: b.slug, logo: b.logo, description: "", productCount: b.productCount, isVisible: true, priceOnApplication: !!b.priceOnApplication }));
}
