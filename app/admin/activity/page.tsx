...
const LABELS: Record<string, string> = {
  ...
  "price-watch:auto-apply": "Nightly price sync", "price-watch:apply": "Price changed in Price watch", "price-watch:manual-apply": "Price matched to Euronics", "price-watch:link-euronics": "Linked to Euronics pages", "catalogue:merge-duplicate": "Merged a duplicate listing", "catalogue:fix-code": "Corrected a model code", "price-update": "Price updated",
